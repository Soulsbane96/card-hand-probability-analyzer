...
#   1. Copy this file to a new name in this folder (e.g.  forest.py).
#      Files starting with "_" are ignored, so rename away from the underscore.
#   2. Change THEME_NAME to whatever you want to appear in the View menu.
#   3. Edit the color values in PALETTE.  Every entry has a comment explaining
#      which part of the UI it controls.
#   4. Restart the app — your theme will appear automatically.
#
# Color format: standard 6-digit hex strings like "#RRGGBB".
# Use "transparent" anywhere you want no color / no border.
# ─────────────────────────────────────────────────────────────────────────────

from __future__ import annotations

THEME_NAME = "my_theme"  # Change this — it shows up in the View menu
...
PALETTE: dict[str, str] = {
    ...
    "checkbox_bg":            "#FAFAFA",  # Area behind a checkbox label (use "transparent" for dark themes)
    ...
    # Tip: on dark themes, set accent_focus to a lighter shade of your accent
    # so it remains visible against dark backgrounds.
    ...
    "accent_faint":           "#E3F2FD",  # Very light tint for selection and hover backgrounds
    ...
    # ── Scrollbars ───────────────────────────────────────────────────────────
    "scrollbar_track":        "#F5F5F5",  # Track / trough background
    "scrollbar_handle":       "#90A4AE",  # Draggable thumb
    "scrollbar_hover":        "#607D8B",  # Thumb color on hover
    ...
    "menubar_bg":             "#ECEFF1",
    "menubar_text":           "#212121",
    "menubar_border":         "transparent",  # Bottom separator line ("transparent" = no line)
